...
int main(){
    ...
    request_sockaddr = set_interface_and_get_binding_addr(generator, "enp0s3", l2_field);
    ...
    reply_sockaddr = set_interface_and_get_binding_addr(generator, "enp0s3", l2_field);
